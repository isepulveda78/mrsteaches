...
const uploadHandler = async (e) => {
    const url = `https://api.cloudinary.com/v1_1/${process.env.NEXT_PUBLIC_CLOUDINARY_CLOUD_NAME}/image/upload?upload_preset=${process.env.NEXT_PUBLIC_CLOUDINARY_PRESET}`;
    try {
      const {
